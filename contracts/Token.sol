...
/**
 * @title MSTV Token Contract
 */
contract MSTV is IERC20Metadata, Ownable, ERC20 {
    /**
     * Sniper Bot and Malicious Actor Protection during the launch stage:
     * The MSTV token employs strategies against sniper bots and malicious users:
     *
     * 1. Selling Fee:
    ...
    string constant private _name = "Modelstream";
    string constant private _symbol = "MSTV";
