...
const projectId = "2SibvctYZUYkdj9fqyqdZz3I6BX";
const projectSecret = "687fe9cd13410da7ce703c2fd3a22cce";
const auth =
...
const dedicateEndPoint = "https://modelstream.infura-ipfs.io/ipfs";
    ...
    if (nftMarketWorkObject && nftMarketWorkObject) {
      ...
      if (account) {
        ...
        console.log(
          ...
          createTokenResult.events
        );
        console.log("createTokenResult createTokenResult", createTokenResult);
      ...
      <div className="bg-[#050505] dark:bg-white">
        <div className="w-full 2xl:max-w-screen-2xl h-auto pt-[104px] m-auto">
          <div className="flex flex-col mx-8 sm:mx-12 lg:mx-[9vw] space-y-6 py-12 text-white dark:text-gray-800">
            ...
            <p className="text-xl">
              We are passionate about empowering models and artists by providing 
                them with a dedicated space to monetize their digital art through (NFTs). 
                Our mission is to foster creativity, encourage innovation, and connect 
                  collectors with exceptional talent from around the world.
            </p>
