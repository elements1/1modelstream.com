            ...
            <div className='flex-1 w-full flex flex-col lg:flex-row space-x-0 space-y-8 lg:space-x-8 lg:space-y-0'>
                <div className='flex-grow text-white dark:text-gray-800'>
                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-2 gap-8'>
                        <div className='flex-1 flex flex-col space-y-6'>
                            ...
                            {props.children.item.sold?"":      <button className='w-48 rounded-full bg-gradient-to-b from-[#ffffff] to-[#ffffff] text-black text-base uppercase py-2 shadow-md m-auto ml-0 border-2 border-[#1E1E1E] dark:border-white' onClick={()=>props.children.buyFunction(props.children.item)}>⚡ BUY NOW</button>
}
                ...
                <div className='flex-none items-start'>
                    <div className='flex flex-row'>
                        ...
                        <h1 className="flex-grow text-[#FFCC33] text-base ml-2">{props.children.item.price} CAD</h1>
                    </div>
                </div>
            </div>
        </div>
