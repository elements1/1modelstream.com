...
export default function Paragraph1() {
  const title = "Discover, Collect, and Sell Models and Fashion NFTs";
  const description =
    "the premier platform for models and artists to showcase and sell their unique digital creations";
