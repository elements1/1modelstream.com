           ...
           if(nftMarketWorkObject && nftMarketWorkObject){
            ...
            console.log(data)
               const items = await Promise.all(data.map(async item=>{
                ...
                const replaceIPFsName =  nftUrl.toString().replace("ipfs.infura.io","modelstream.infura-ipfs.io")
            ...
            const replaceIPFsImageName =  oldImageUrl.toString().replace("ipfs.infura.io","modelstream.infura-ipfs.io")
